...
public class VoidInfuserScreen extends AbstractContainerScreen<VoidInfuserMenu>
{
    private static final ResourceLocation GUI_TEXTURE =
            ResourceLocation.fromNamespaceAndPath(TokuHeroes.MOD_ID,"textures/gui/void_infuser/void_infuser_gui.png");
    private static final ResourceLocation ARROW_TEXTURE =
            ResourceLocation.fromNamespaceAndPath(TokuHeroes.MOD_ID,"textures/gui/arrow_progress.png");
