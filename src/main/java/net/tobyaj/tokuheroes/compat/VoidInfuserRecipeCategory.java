...
{
    public static final ResourceLocation UID = ResourceLocation.fromNamespaceAndPath(TokuHeroes.MOD_ID, "void_infuser");
    ...
    {
        return Component.translatable("block.tokuheroes.void_infuser");
    }
